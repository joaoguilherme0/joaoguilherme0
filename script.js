...
const perguntas = [
    ...
    {
        enunciado: "Quais os princípais causadores do aquecimento global?",
        alternativas: [
            {
                texto: "Fábricas, derrubada de floresta, transporte, prodeção de alimentos, etc...",
                afirmacao: "afirmação."
            },
            {
                texto: "Luz solar,animais e plantio.",
                afirmacao: "afirmação"
            }
        ]
    },
